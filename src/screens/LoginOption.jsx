  ...
  return (
    ...
    />
     <Rect
      width="742.985"
      height="719.227"
      transform="matrix(1.000357 0.957232 -3.9962169 3.0022   -415.239 0.879297 )"
      fill="#1D92F1"
      fillOpacity="0.65"
    />
...
<View className="w-full items-center p-9">
          ...
          <TouchableOpacity className="border-2 border-blue-500 rounded-xl bg-blue-100 flex-row items-center mb-4 px-6 py-2">
          ...
          <TouchableOpacity className="border-2 border-green-500 bg-blue-100 rounded-xl flex-row items-center px-6 py-2">
            <Text className="text-2xl text-blue-500 font-semibold mr-2">Login Via Email</Text>
            <MaterialIcons name="mail" size={30} color="green" />
          </TouchableOpacity>
        </View>
        </View>
